...
# Read your data
data = pd.read_csv("LH_IN_OPP.csv")
data2 = pd.read_csv("LH_IN_STR.csv")
data3 = pd.read_csv("LH_IN_PULL.csv")
data4 = pd.read_csv("LH_MID_OPP.csv")
data5 = pd.read_csv("LH_MID_STR.csv")
data6 = pd.read_csv("LH_MID_PULL.csv")
data7 = pd.read_csv("LH_OUT_OPP.csv")
data8 = pd.read_csv("LH_OUT_STR.csv")
data9 = pd.read_csv("LH_OUT_PULL.csv")
data10 = pd.read_csv("RH_IN_OPP.csv")
data11 = pd.read_csv("RH_IN_STR.csv")
data12 = pd.read_csv("RH_IN_PULL.csv")
data13 = pd.read_csv("RH_MID_OPP.csv")
data14 = pd.read_csv("RH_MID_STR.csv")
data15 = pd.read_csv("RH_MID_PULL.csv")
data16 = pd.read_csv("RH_OUT_OPP.csv")
data17 = pd.read_csv("RH_OUT_STR.csv")
data18 = pd.read_csv("RH_OUT_PULL.csv")
