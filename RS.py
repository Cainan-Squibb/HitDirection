...
#read csvs
data = pd.read_csv("CSVs\RS_LH_IN_PULL.csv")
data2 = pd.read_csv("CSVs\RS_LH_OUT_PULL.csv")
data3 = pd.read_csv("CSVs\RS_RH_IN_PULL.csv")
data4 = pd.read_csv("CSVs\RS_RH_OUT_PULL.csv")
data5 = pd.read_csv("CSVs\RS_RH_INP.csv")
data6 = pd.read_csv("CSVs\RS_LH_INP.csv")
data7 = pd.read_csv("CSVs\RS_RH_BP.csv")
data8 = pd.read_csv("CSVs\RS_LH_BP.csv")
data9 = pd.read_csv("CSVs\RS_RH_BIP.csv")
data10 = pd.read_csv("CSVs\RS_LH_BIP.csv")
data11 = pd.read_csv("CSVs\RS_RH_TP.csv")
data12 = pd.read_csv("CSVs\RS_LH_TP.csv")
data13 = pd.read_csv("CSVs\RS_RH_MIDP.csv")
data14 = pd.read_csv("CSVs\RS_LH_MIDP.csv")
data15 = pd.read_csv("CSVs\RS_RH_MID_PULL.csv")
data16 = pd.read_csv("CSVs\RS_LH_MID_PULL.csv")
